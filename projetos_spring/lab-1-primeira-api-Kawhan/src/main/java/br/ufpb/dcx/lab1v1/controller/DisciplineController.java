...
public class DisciplineController {
    ...
    public ResponseEntity<DisciplineResponseDTO> addNewDisciplines(@RequestBody @Valid DisciplineNameRequestDTO disciplineNameRequestDTO) throws DisciplineAlreadyExistsException {
    ...
    public ResponseEntity<DisciplineResponseDTO> getIndividualDiscipline(@PathVariable Integer id) throws DisciplineNotFoundException {
    ...
    public ResponseEntity<DisciplineResponseDTO> changeNameDiscipline(@PathVariable Integer id, @RequestBody @Valid DisciplineNameRequestDTO disciplineNameRequestDTO) throws DisciplineNotFoundException, DisciplineNameAlreadyExists {
    ...
    public ResponseEntity<DisciplineResponseDTO> addGradeDiscipline(@PathVariable Integer id, @RequestBody @Valid DisciplineGradeRequestDTO disciplineGradeRequestDTO) throws DisciplineNotFoundException {
    ...
    public ResponseEntity<DisciplineResponseDTO> addLikeDiscipline(@PathVariable Integer id) throws DisciplineNotFoundException {
    ...
    public ResponseEntity<DisciplineResponseDTO> removeDiscipline(@PathVariable Integer id) throws DisciplineNotFoundException {
